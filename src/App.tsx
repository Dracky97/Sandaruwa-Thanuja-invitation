...
const RSVP_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbx1eKsAoDzcN1xPhbhmBllnHmcgKwShjMYIfACX6UrCCpcFQhO3g_scPW1bSRvCbUTSyQ/exec';
const RSVP_FORM_TARGET = 'rsvp-submit-frame';

export default function App() {
  const [rsvpForm, setRsvpForm] = useState({ name: '', email: '', phone: '', attending: 'yes', guests: '1' });
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span>Sheraton Kosgoda Turtle Beach Resort</span>
              </div>
            </motion.div>
          </motion.div>
        ...
        <section id="details" className="min-h-screen flex items-center justify-center w-full px-4 py-20">
          <div className="max-w-5xl w-full grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-2">August 13, 2026</h3>
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-2">09:00 AM - 3:30 PM</h3>
              <p className="text-white/80 font-light leading-relaxed mb-6">
                09:46 AM - Poruwa<br />
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-2">Sheraton Kosgoda Turtle Beach Resort</h3>
              <p className="text-white/80 font-light leading-relaxed mb-6">
                Kosgoda<br />
                Sri Lanka
              </p>
              
              <a href="https://maps.app.goo.gl/GnquYBAGEfKYFZry5" className="glass-button px-6 py-3 text-sm tracking-wider uppercase mt-auto">
                View Map
              </a>
            </motion.div>
          </div>
          ...
          >
            ...
            <h2 className="font-serif text-3xl md:text-5xl leading-relaxed font-light italic">
              "Life wrote our souls into the same story!"
                  ...
                  <p className="mt-8 text-white/60 tracking-widest uppercase text-sm font-serif font-light italic">Thanuja & Sandaruwan</p>
          </motion.div>
        </section>
        ...
        <section id="rsvp" className="min-h-screen flex items-center justify-center w-full px-4 py-20">
          ...
          >
            ...
            {isSubmitted ? (
              ...
              <form
                action={RSVP_SCRIPT_URL}
                method="POST"
                target={RSVP_FORM_TARGET}
              ...
              >
                ...
                <div className="space-y-2">
                  <label className="text-sm tracking-widest uppercase text-white/80 ml-4">Phone Number</label>
                  <input
                    name="phone"
                    type="tel"
                    required
                ...
                <button 
                  ...
                  className="glass-button w-full py-5 rounded-full text-lg tracking-widest uppercase font-medium mt-8 flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:opacity-60"
                >
